...
AIU has other strategies for updating images and can among other things used to detect and respect SemVer changes. We refer to the AIU documentation for the specifics. 
...
changes the `values.yaml` is left unmodified. 
